                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="grade">
                                ...
                                <?php foreach ($grades as $grade) : ?>
                                    <option value="<?= $grade['id'] ?>" <?= $question['grade_id'] == $grade['id'] ? 'selected' : '' ?>><?= $grade['name'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" style="max-width: 150px;" id="calculatorEnabled">
                                <option value="0" <?= $question['calculator_enabled'] == 0 ? 'selected' : '' ?>>Disabled</option>
                                <option value="1" <?= $question['calculator_enabled'] == 1 ? 'selected' : '' ?>>Enabled</option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        $("#saveBtn").click(async function(e) {
            ...
            if (questionType == "text") {
                ...
                $("#textAnswerInputsWrapper .text-answer-input-wrapper").each(function(index, input) {
                    let answer = $(this).find(".text-answer-input").val().trim();
                ...
                if (foundEmpty) {
                    new Notify({
                        title: 'Error',
                        text: 'An empty answer is not allowed',
                        status: 'error',
                        autoclose: true,
                        autotimeout: 3000
                    });
